		...
		<div className="bg-white">
			<div className="grid grid-cols-1 md:grid-cols-5">
				<Image
					...
					width={1000}
					height={1000}
					className="aspect-video w-auto h-full object-cover order-2 md:order-1 col-span-2"
				/>
				<div className="flex items-center justify-center flex-col py-16 order-1 md:order-2 col-span-3">
					...
					<div className="container mt-4">
						...
						>
							Founded to address the growing need for skilled
							forensic professionals in Africa and beyond, WASFS
							is committed to providing high-quality education
							through expert-led training and real-world case
							studies. Our programs bridge the gap between
							theoretical knowledge and practical forensic
							application, ensuring our graduates are
							industry-ready.
						</p>
					</div>
				</div>
